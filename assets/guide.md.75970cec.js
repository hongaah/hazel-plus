import{_ as s,o as a,c as n,b as l}from"./app.cbfb0c1f.js";const m=JSON.parse('{"title":"\u5FEB\u901F\u5B89\u88C5 test","description":"","frontmatter":{"realPath":"docs/guide.md"},"headers":[{"level":2,"title":"\u{1F4E6} Install","slug":"\u{1F4E6}-install"},{"level":2,"title":"\u{1F9E8} Quickstart","slug":"\u{1F9E8}-quickstart"}],"relativePath":"guide.md"}'),p={name:"guide.md"},o=l(`<h1 id="\u5FEB\u901F\u5B89\u88C5-test" tabindex="-1">\u5FEB\u901F\u5B89\u88C5 test <a class="header-anchor" href="#\u5FEB\u901F\u5B89\u88C5-test" aria-hidden="true">#</a></h1><h2 id="\u{1F4E6}-install" tabindex="-1">\u{1F4E6} Install <a class="header-anchor" href="#\u{1F4E6}-install" aria-hidden="true">#</a></h2><div class="language-"><button class="copy"></button><span class="lang"></span><pre class="vp-code-dark"><code><span class="line"><span style="color:#c9d1d9;"># using npm to install</span></span>
